...
<!-- gallery:screenshots -->
Every section has its own capture next to the component it documents; the pairs below are the ones where the theme is the point. All 74 images are regenerated by `npm run docs:shots`.
