...
<!-- gallery:screenshots -->
Cada seção tem a própria captura ao lado do componente que documenta; os pares abaixo são aqueles em que o tema é o assunto. As 73 imagens são regeneradas por `npm run docs:shots`.
