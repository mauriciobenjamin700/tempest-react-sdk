...
export function AdvancedComponentsSection() {
    ...
    return (
        <section className="gallery-section" id="advanced">
            ...
            <Example
                title="Stepper · Progress · ChipInput · Avatars"
                note="Quatro cards num grid de 2 colunas, cada um com estado próprio."
...
<Grid columns={2} gap={4}>
    ...
    <Card title="Progress">
        <Stack gap={3}>
            ...
            <Stack direction="horizontal" gap={2}>
                <Button variant="secondary" size="sm" onClick={() => setProgress(Math.max(0, progress - 10))}>
                    -10
                </Button>
    ...
    <Card title="Avatars">
        <Stack direction="horizontal" gap={3} wrap>
            ...
            <Avatar src="https://i.pravatar.cc/120?img=14" name="Carlos" size="xl" status="online" />
        </Stack>
    </Card>
</Grid>`}
            >
            ...
            <Example
                title="FileUpload"
                note="Drag-and-drop multi-arquivo com limite de tipo e tamanho."
...
/>`}
            ...
            <Example
                title="VirtualList — 5.000 linhas"
                note="Renderiza só as linhas visíveis; rola 5.000 itens sem travar."
                code={`const ROWS = Array.from({ length: 5000 }, (_, i) => ({ id: i, label: \`Linha #\${i + 1}\` }));
