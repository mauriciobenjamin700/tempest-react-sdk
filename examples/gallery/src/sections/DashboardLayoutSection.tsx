...
export function DashboardLayoutSection() {
    return (
        <section className="gallery-section" id="dashboard-layout">
            <h3>Dashboard (grid por container query)</h3>
            <Example
    ...
    <section className="tempest-widget tempest-widget-half">…</section>
                ...
                props={[
                    ...
                    },
                    {
                        ...
                        type: "auto-fit",
                        description:
                            "Fileira de tiles sem span nenhum. `--tempest-stat-min` ajusta.",
                    },
                    {
                    ...
                    <div className="tempest-dashboard">
                        <section className="tempest-widget tempest-widget-two-thirds">
                            <div className="tempest-widget-frame">
                                <div className="tempest-widget-header">
                                    <h2 className="tempest-widget-title">Vendas por dia</h2>
                                    <span className="tempest-text-subtle tempest-text-xs">
                                        12 dias
                                    </span>
                                </div>
                            ...
                            <div className="tempest-widget-frame">
                                ...
                                <div className="tempest-widget-body">
                                    <p className="tempest-text-sm" style={{ margin: 0 }}>
                                        A janela de manutenção do banco é domingo, 02:00–04:00. O
                                        time de dados foi avisado e o deploy fica travado no sábado.
                                    </p>
                                </div>
                            </div>
                        </section>
