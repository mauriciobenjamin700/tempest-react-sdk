...
export function FeedbackSection() {
    return (
        <section className="gallery-section" id="feedback">
            ...
            <Example
                title="Badges"
                note="neutral · success · warning · danger · info"
...
<Badge variant="info">Em revisão</Badge>`}
            ...
            <Example
                title="Cards, Spinner e Skeleton"
                note="Card aceita title, actions e composição livre no corpo."
                code={`<Card title="Receita mensal" actions={<Badge variant="success">+12%</Badge>}>
...
<Card title="Status do sistema">
    <span><Badge variant="success">●</Badge> API operacional</span>
    <span><Badge variant="warning">●</Badge> Push degradado</span>
</Card>
<Card title="Loading">
    <Spinner size="md" />
